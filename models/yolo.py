...
from models.dc3swt import DC3SWT          # DC3SWT: deformable attention replaces W-MSA+SW-MSA, see arxiv:2010.04159
...
def parse_model(d, ch):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            DWConvTranspose2d,
            C3x,
            C3SWT, DC3SWT, CoordAttMulti, CoordAtt
        }:
            c1, c2 = ch[f], args[0]
            ...
            if m in {BottleneckCSP, C3, C3TR, C3Ghost, C3x, C3SWT, DC3SWT}:
